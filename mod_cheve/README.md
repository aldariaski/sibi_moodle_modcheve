A template for Moodle modules.  Updated from Moodle HQ's moodle-mod_cheve template.
...
Assuming you are going to change your module name from cheve to something more relevant, do the following.

Rename these files:
===================
All 4 files in backup/moodle2 should have the name of your new module.

The lang/en/cheve.php file should be renamed to the name of your new module.

Replace cheve with your new module name
========================================
Carry out a search and replace for "cheve" replacing it with the name of your new module.  You can do this in a number of ways depending on your text editor.  If you don't have one handy, download Brackets (http://brackets.io/) which is free, open source and handles this stuff well.
...
<pre>
\mod_cheve\local\debugging::logit("What is in a widegt: ", $cheve);
</pre>
